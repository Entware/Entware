...
define Package/openssl/add-engine
  ...
  Package/$$(OSSL_ENG_PKG)/conffiles:=/opt/etc/ssl/engines.cnf.d/$(1).cnf
  ...
  define Package/$$(OSSL_ENG_PKG)/install
	...
	$$(INSTALL_DIR)  $$(1)/opt/etc/ssl/engines.cnf.d
	$$(INSTALL_DATA) ./files/$(1).cnf $$(1)/opt/etc/ssl/engines.cnf.d/
  endef
...
[ -n "$$$${IPKG_INSTROOT}" ] || /opt/etc/init.d/openssl reload
  endef
